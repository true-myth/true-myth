...
[Getting started](./getting-started) has installation and configuration instructions. The [Tutorial](./tutorial/) walks through basic examples of how to use the library.
...
Finally, the Background materials may be of interest for particularly curious users!
