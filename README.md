...
| ------------ | --------- | -------------- | ----------------------- |
| `index.js`   | 0.132     | 0.081          | 0.089                   |
| `maybe.js`   | 9.7       | 5.3            | 1.5                     |
| `result.js`  | 9.4       | 9.4            | 1.4                     |
| `unit.js`    | 0.134     | 0.092          | 0.114                   |
| `utils.js`   | 0.277     | 0.128          | 0.145                   |
| **total**[3] | 20.781    | 15.001         | 3.257                   |

1. Using [terser](https://github.com/terser/terser) 5.6.1 with `--compress --mangle --mangle-props`.
