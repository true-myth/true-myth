...
_NOTE: this documentation is for version 6.x onwards, [which requires using Node 16 module resolution](#requirements). If you cannot use that yet, please use version 5.x._
