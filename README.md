...
<p align="center">
  ...
  <a href='https://github.com/true-myth/true-myth/blob/main/.github/workflows/CI.yml#L59'>
    <img src='https://img.shields.io/badge/TypeScript-4.2%20%7C%204.3%20%7C%204.4%20%7C%204.5%204.5%20%7C%20next-3178c6' alt='supported TypeScript versions'>
  </a>
...
| file              | size (KB) | terser[^terser] (KB) | terser and gzip[^gzip] (KB) |
| ----------------- | --------- | -------------------- | --------------------------- |
| index.js          | 0.137 KB  | 0.088 KB             | 0.083 KB                    |
| maybe.js          | 6.7 KB    | 3.5 KB               | 1.1 KB                      |
| result.js         | 6.5 KB    | 3.3 KB               | 0.989 KB                    |
| unit.js           | 0.206 KB  | 0.133 KB             | 0.129 KB                    |
| utils.js          | 0.192 KB  | 0.082 KB             | 0.108 KB                    |
| **total[^total]** | 13.735 KB | 7.103 KB             | 2.409 KB                    |

[^terser]: Using [terser](https://github.com/terser/terser) 5.10.0 with `--compress --mangle --mangle-props`.

[^gzip]: Generated by running `gzip -k9` on the result of the `terser` invocation.
